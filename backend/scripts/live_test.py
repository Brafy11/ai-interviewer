...
# The example caregiver role. Same text as the frontend's "Use example"
# button, so the UI picker matches.
EXAMPLE_JD = """Caregiver (CNA / HHA / PCA / Home Health Aide) — Clearhaven Home Care
