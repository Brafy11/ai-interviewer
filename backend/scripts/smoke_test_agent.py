...
RESUME_TEXT = (
    "Maria Delgado. Home caregiver, ~3 years at Riverbend Home Care and Cedar Ridge "
    "Assisted Living. Bilingual English/Spanish. CPR/First Aid expired 2024. Available weekdays."
)
JD_TEXT = (
    "Clearhaven Home Care is hiring a Caregiver in Fairview County, OH. Weekend and "
    "evening shifts as needed. Requires driver's license, current CPR, TB test."
)
