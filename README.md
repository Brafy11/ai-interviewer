...
A full-stack AI interview coach built for the Sigma technical assessment. Upload a resume, paste a job description, run an adaptive AI interview grounded in a real gap analysis between the two, and get a structured final report.
